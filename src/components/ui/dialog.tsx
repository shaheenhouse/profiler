...
interface DialogContentProps extends React.ComponentPropsWithoutRef<typeof DialogPrimitive.Content> {
  ...
  /** Screen-reader only title for accessibility (use when no visible DialogTitle) */
  srTitle?: string;
}
...
const DialogContent = React.forwardRef<
  ...
  DialogContentProps
>(({ className, children, hideCloseButton, srTitle = "Dialog", ...props }, ref) => (
  <DialogPortal>
    <DialogOverlay />
    ...
    >
      ...
      <VisuallyHidden.Root>
        <DialogPrimitive.Title>{srTitle}</DialogPrimitive.Title>
